...
import RealTimeline from '@/assets/images/projects/masters-thesis/real-timeline.png';
import CounterfactualTimeline from '@/assets/images/projects/masters-thesis/counterfactual-timeline.png';
